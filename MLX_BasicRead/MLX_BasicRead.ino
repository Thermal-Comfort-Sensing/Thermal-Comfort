...
void loop() {
  ...
  Serial.print("Object temperatures: \t");
  Serial.print(objTemp1);
  Serial.print(" \t");
  Serial.println(objTemp2);
  delay(500);
}
...
//  uint16_t ret;
//
//  Wire.beginTransmission((uint8_t)0x5A); // start transmission to device 
...
//{
//  Serial.print("\nAmbient: \t");
//    uint16_t readVal = read16(MLX90614_TA);
